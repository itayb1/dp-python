...
slm_action_request_body = {
     "StylePolicyAction": {
        "name": "HTTPToHTTP_ToHTTPDest_rule_slm_0",
        "mAdminState": "enabled",
        "Type": "slm",
        "Input": "INPUT",
        "ParseSettingsReference": {
...
slm_policy_statement = {
    "SLMId": 1,
    "UserString": "Count Threshold",
    "CredClass": "",
    "RsrcClass": "",
    "Schedule": "",
    "Action": {
    ...
    "ThreshIntervalLength": 1,
    "ThreshIntervalType": "moving",
    "ThreshAlgorithm": "greater-than",
    "ThresholdType": "count-all",
    "ThresholdLevel": 10,
    "ReleaseThresholdLevel": 0,
    "BurstLimit": 0,
    "ReportingAggregationInterval": 0,
    "MaximumTotalReportingRecords": 5000,
    "AutoGeneratedByWebGUI": "off",
    "MaximumResourcesAndCredentialsForThreshold": 5000
}

slm_policy = {   
    "SLMPolicy": {
        "name": "SLM_Test_Policy",
        "mAdminState": "enabled",
        "ExecutionPolicy": "execute-all-statements",
        "Statement": [
        ]
    }
}